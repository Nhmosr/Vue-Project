<template lang="html">
  <li class="goods-list" v-on:click="doSomething">
    <!-- <router-link :to="{ path: '/detail', params:{ userId: 123 }}"  class="goods-list-link">  <! 这个是用来跳转页面的，可以理解为a标签 -->
...
export default {
  ...
  methods:{
    doSomething:function() {
      debugger
      // router.push({ path: '/detail', params: { userId: 123 }})
